        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="space-y-4">
               ...
               <button 
                  onClick={scrollToTop}
                  className="w-full py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-slate-400 hover:text-white transition-all flex items-center justify-center gap-2 text-xs cursor-pointer font-bold"
               >
