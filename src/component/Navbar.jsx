  ...
  return (
    ...
    >
      <div className="container mx-auto flex justify-between items-center px-6 md:px-12">
        ...
        <div
          ref={mobileMenuRef}
          className="fixed top-0 right-0 z-[150] flex h-screen w-[60%] flex-col border-l border-white/5 bg-[#050507] p-8 shadow-[-20px_0_50px_rgba(0,0,0,0.5)] sm:w-[50%] md:w-[40%]"
        >
          {/* CLOSE BUTTON */}
